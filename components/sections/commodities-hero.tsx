                ...
                <div className="mx-auto max-w-6xl px-6 py-20 lg:py-24">
                    <div className="mx-auto max-w-4xl text-center">
                        <h2 className="font-tasa text-[34px] leading-tight font-medium text-[#1F1F1F] md:text-[40px]">
                            Trade global commodities with precision,{" "}
                            <span className="text-[#A98743] font-medium">
                                transparency, and institutional-grade execution.
                            </span>
                        </h2>

                        <p className="mx-auto mt-8 max-w-3xl text-[13.5px] leading-relaxed text-[#7B7B7B]">
                            Monexo Capital provides access to some of the world’s most actively traded raw materials — including energy, metals, and agricultural products — all through a powerful and secure trading environment.
                        </p>
                    </div>
                </div>
            </section>

            {/* ── Trade Essential Commodities Section (LIGHT) ────────────────────────── */}
            <section className="bg-[#FBF6F0]">
                <div className="mx-auto max-w-6xl px-6 py-20 lg:py-24">
                    <div className="grid gap-14 lg:grid-cols-2 lg:items-start">
                        ...
                        <div className="max-w-xl">
                            ...
                            <p className="mt-6 text-[14px] leading-7 text-[#7B7B7B]">
                                Commodities drive global economies. From energy markets to precious
                                metals and agricultural goods, these assets offer diverse trading
                        ...
                        <div className="grid gap-x-16 gap-y-12 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <p className="mt-3 text-[13.5px] leading-7 text-[#7B7B7B]">
                                    Trade the world’s most actively traded energy commodities. Oil markets
                                    are known for strong volatility and reaction to geopolitical and
                                    economic events — ideal for active traders.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-3 text-[13.5px] leading-7 text-[#7B7B7B]">
                                    A traditional safe-haven asset, gold is widely traded during periods
                                    of inflation, currency shifts, and global uncertainty.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-3 text-[13.5px] leading-7 text-[#7B7B7B]">
                                    ...
                                    offering both volatility and diversification benefits.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-3 text-[13.5px] leading-7 text-[#7B7B7B]">
                                    Access key agricultural markets such as wheat, coffee, corn, and
                                    soybeans — influenced by weather, supply chains, and global demand cycles.
                                </p>
                            </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start mb-24">
                        <div>
                            ...
                            <h2 className="text-[46px] leading-[1.08] font-semibold text-[#2A1E1E]">
                                Why Trade Commodities with Monexo Capital?
                            </h2>
                        </div>

                        <div className="flex items-start lg:justify-end">
                            <p className="text-[15px] leading-7 text-[#2A1E1E]/80 max-w-md">
                                Commodities trading involves speculating on the price movements of raw materials such as oil, metals, and agricultural goods.

                                Rather than taking physical delivery, traders speculate on price fluctuations through derivative contracts — allowing both long and short positions depending on market direction.
                            </p>
                        </div>
                    </div>
