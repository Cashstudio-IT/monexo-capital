...
import { AmazonLogo, AppleLogo, MetaLogo, MicrosoftLogo } from "../icons/brand-logos";
                ...
                <div className="mx-auto max-w-6xl px-6 py-20 lg:py-24">
                    <div className="mx-auto max-w-4xl text-center">
                        <h2 className="font-tasa text-[34px] leading-tight font-medium text-[#1F1F1F] md:text-[40px]">
                            Trade shares of the world’s leading companies with{" "}
                        ...
                        <p className="mx-auto mt-8 max-w-3xl text-[13.5px] leading-relaxed text-[#7B7B7B]">
                            Monexo Capital gives you access to global stock markets with transparent pricing, fast execution, and professional-grade trading tools designed for modern investors and active traders.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid gap-14 lg:grid-cols-2 lg:items-start">
                        ...
                        <div className="max-w-xl">
                            ...
                            <p className="mt-6 text-[14px] leading-7 text-[#7B7B7B]">
                                Gain direct exposure to some of the world’s most influential publicly
                                listed companies. With Monexo Capital, trade stocks across major
                                global exchanges with reliable liquidity and real-time pricing.
                            </p>
                        ...
                        <div className="grid gap-x-16 gap-y-12 sm:grid-cols-2">
                            {/* Card 1 */}
                            <div>
                                <AppleLogo className="h-14 w-14 text-black" />
                                <h3 className="mt-5 text-[18px] font-semibold text-[#1F1F1F]">Apple (AAPL)</h3>
                                <p className="mt-3 text-[13.5px] leading-7 text-[#7B7B7B]">
                                    Trade shares of a global tech leader driving innovation in consumer electronics and services.
                                </p>
                            </div>

                            {/* Card 2 */}
                            <div>
                                <AmazonLogo className="h-14 w-14 text-black" />
                                <h3 className="mt-5 text-[18px] font-semibold text-[#1F1F1F]">Amazon (AMZN)</h3>
                                <p className="mt-3 text-[13.5px] leading-7 text-[#7B7B7B]">
                                    Trade a dominant force in global e-commerce, logistics, and cloud infrastructure.
                                </p>
                            </div>

                            {/* Card 3 */}
                            <div>
                                <MetaLogo className="h-14 w-14 text-black" />
                                <h3 className="mt-5 text-[18px] font-semibold text-[#1F1F1F]">Meta Platforms (META)</h3>
                                <p className="mt-3 text-[13.5px] leading-7 text-[#7B7B7B]">
                                    Trade shares of a major player in social media, digital advertising, and emerging technologies.
                                </p>
                            </div>

                            {/* Card 4 */}
                            <div>
                                <MicrosoftLogo className="h-14 w-14 text-black" />
                                <h3 className="mt-5 text-[18px] font-semibold text-[#1F1F1F]">Microsoft (MSFT)</h3>
                                <p className="mt-3 text-[13.5px] leading-7 text-[#7B7B7B]">
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-[15px] leading-8 text-[#2A1E1E]/80 max-w-lg mb-10">
                            Stock trading involves buying and selling shares of publicly listed companies. By trading stocks, you participate directly in a company’s performance and market valuation — whether you aim for short-term opportunities or longer-term positioning.
                        </p>
