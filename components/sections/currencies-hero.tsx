...
export default function CurrenciesHero() {
    return (
                ...
                <div className="mx-auto max-w-6xl px-6 py-20 lg:py-24">
                    <div className="mx-auto max-w-4xl text-center">
                        <h2 className="font-tasa text-[34px] leading-tight font-medium text-[#1F1F1F] md:text-[40px]">
                            Access the global currency market with{" "}
                            <span className="text-[#A98743] font-medium">
                                speed, transparency, and institutional-grade execution.
                            </span>
                        </h2>

                        <p className="mx-auto mt-8 max-w-3xl text-[13.5px] leading-relaxed text-[#7B7B7B]">
                            Monexo Capital provides competitive spreads, deep liquidity, and advanced trading technology — empowering you to trade currencies with precision and control.
                        </p>
                    </div>
                </div>
            </section>

            {/* ── Trade the World’s Most Liquid Market (LIGHT) ────────────────────────── */}
            <section className="bg-[#FBF6F0]">
                <div className="mx-auto max-w-6xl px-6 py-20 lg:py-24">
                    <div className="grid gap-14 lg:grid-cols-2 lg:items-start">
                        ...
                        <div className="max-w-xl">
                            <h2 className="text-[46px] leading-[1.05] font-semibold text-[#1F1F1F]">
                                Trade the World’s Most <br />
                                Liquid Market
                            </h2>

                            <p className="mt-6 text-[14px] leading-7 text-[#7B7B7B]">
                                The currency market is the largest and most liquid financial market globally, operating 24 hours a day, five
                                days a week. Trade major, minor, and selected exotic currency pairs with real-time pricing and fast execution.
                            </p>
                        ...
                        <div className="grid gap-x-16 gap-y-16 sm:grid-cols-2">
                            {/* 1 */}
                            <div>
                                <h3 className="text-[18px] font-semibold text-[#1F1F1F]">EUR/USD</h3>
                                <p className="mt-3 text-[13.5px] leading-7 text-[#7B7B7B]">
                                    The most traded currency pair in the world, offering tight spreads and consistent liquidity.
                                </p>
                            </div>

                            {/* 2 */}
                            <div>
                                <h3 className="text-[18px] font-semibold text-[#1F1F1F]">GBP/USD</h3>
                                <p className="mt-3 text-[13.5px] leading-7 text-[#7B7B7B]">
                                    Known for volatility and strong intraday movements — popular among day traders and scalpers.
                                </p>
                            </div>

                            {/* 3 */}
                            <div>
                                <h3 className="text-[18px] font-semibold text-[#1F1F1F]">USD/JPY</h3>
                                <p className="mt-3 text-[13.5px] leading-7 text-[#7B7B7B]">
                                    A highly liquid pair often influenced by global risk sentiment and monetary policy decisions.
                                </p>
                            </div>

                            {/* 4 */}
                            <div>
                                <h3 className="text-[18px] font-semibold text-[#1F1F1F]">AUD/USD &amp; USD/CAD</h3>
                                <p className="mt-3 text-[13.5px] leading-7 text-[#7B7B7B]">
                                    Commodity-linked currencies offering trading opportunities driven by energy and resource markets.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start mb-24">
                        <div>
                            ...
                            <h2 className="text-[46px] leading-[1.08] font-semibold text-[#2A1E1E]">
                                Why Trade Currencies with Monexo Capital?
                            </h2>
                        </div>

                        <div className="flex items-start lg:justify-end">
                            <p className="text-[15px] leading-7 text-[#2A1E1E]/80 max-w-md">
                                Monexo Capital is built for traders who demand efficiency, reliability, and professional-grade tools.
                            </p>
                        </div>
                    </div>
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-[15px] leading-8 text-[#2A1E1E]/80 max-w-lg mb-10">
                            Currency trading involves buying one currency while simultaneously selling another. Currency pairs reflect the exchange rate between two economies. For example, in EUR/USD, traders speculate whether the euro will strengthen or weaken against the US dollar.
                        </p>
